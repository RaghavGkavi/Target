...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    content: (
      <div className="text-center space-y-4">
        ...
        <p>
          Target helps you build lasting habits, break addictions, and track
          your discipline journey. Let's take a quick tour to get you started!
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-primary/10 p-4 rounded-lg">
          <p className="text-sm">
            <strong>💡 Pro Tip:</strong> Start with small, achievable goals to
            build momentum!
          </p>
        </div>
      </div>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-success/10 p-4 rounded-lg">
          <p className="text-sm">
            <strong>💚 Remember:</strong> Recovery is a journey. Every day
            counts, and setbacks are part of the process.
          </p>
        </div>
      </div>
    ),
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center space-x-2 p-4 bg-primary/10 rounded-lg">
          ...
          <span className="font-semibold">
            Keep completing goals to improve your rank!
          </span>
        </div>
      </div>
    ),
      ...
      <div className="space-y-4">
        ...
        <div className="text-center p-4 bg-primary/10 rounded-lg">
          ...
          <p className="text-sm text-muted-foreground">
            You're all set! Click "Get Started" to begin building better habits
            today.
          </p>
        </div>
      </div>
