...
export const QUEST_LIBRARY: QuestTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Complete 45 minutes of focused learning using online tutorials, courses, or educational videos on a specific skill",
    category: "learning",
    difficulty: "moderate",
    xpReward: QUEST_XP_VALUES.moderate,
    icon: "🎓",
  ...
  },
  {
    ...
    title: "Deep Focus",
    description:
      "Work on a specific high-priority task for 1 hour with phone on silent and all notifications disabled",
    category: "career",
    difficulty: "moderate",
    xpReward: QUEST_XP_VALUES.moderate,
    icon: "⚡",
  ...
  },
  {
    ...
    description:
      "Spend 30 minutes actively creating: write 500+ words, draw/sketch, practice an instrument, or work on a craft project",
    category: "creativity",
    difficulty: "moderate",
    xpReward: QUEST_XP_VALUES.moderate,
    icon: "✨",
  ...
  },
  {
    ...
    description:
      "Create a detailed weekly schedule with specific time blocks for work, exercise, meals, and personal time",
    category: "productivity",
    difficulty: "moderate",
    xpReward: QUEST_XP_VALUES.moderate,
    icon: "📋",
  ...
  },
  {
    ...
    description:
      "Have an intentional 30-minute conversation with someone about their goals, feelings, or something meaningful to them",
    category: "social",
    difficulty: "moderate",
    xpReward: QUEST_XP_VALUES.moderate,
    icon: "💬",
  ...
  // HARD QUESTS (20 XP each) - Expanded library
  {
    ...
    title: "Beast Mode",
    description:
      "Complete a 45-minute high-intensity workout: HIIT training, weight lifting, or challenging cardio that pushes your limits",
    category: "fitness",
    difficulty: "hard",
  ...
  },
  {
    ...
    description:
      "Complete a full chapter/module of an online course, including all videos, readings, and exercises/quizzes",
    category: "learning",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "📚",
  ...
  },
  {
    ...
    description:
      "Send personalized messages to 3 professional contacts: update them on your work, ask about theirs, or suggest meeting up",
    category: "career",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🤝",
  ...
  },
  {
    ...
    title: "Focus Warrior",
    description:
      "Complete 2 uninterrupted hours on your most important project with phone in another room and all distractions eliminated",
    category: "productivity",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🎯",
  ...
  },
  {
    ...
    description:
      "Plan and host a gathering (dinner party, game night, study group) or attend a networking/community event where you meet new people",
    category: "social",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🎉",
  ...
  },
  {
    ...
    title: "Art Creator",
    description:
      "Complete a substantial creative work: finish a short story/poem, create a detailed artwork, compose a song, or complete a craft project",
    category: "creativity",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🖼️",
  ...
  },
  {
    ...
    title: "Inner Journey",
    description:
      "Practice 1 hour of deep meditation, mindfulness, or contemplative practice in a quiet space without interruptions",
    category: "mindfulness",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🕯️",
  ...
  },
  {
    ...
    description:
      "Achieve a personal fitness goal: run 5K without stopping, do 100 push-ups, hold plank for 5 minutes, or similar challenge",
    category: "fitness",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "🏃‍♂️",
  ...
  },
  {
    ...
    title: "Habit Breaker",
    description:
      "Go the entire day without engaging in a specific bad habit (smoking, junk food, excessive social media, etc.)",
    category: "recovery",
    difficulty: "hard",
    xpReward: QUEST_XP_VALUES.hard,
    icon: "💪",
  ...
  // VERY HARD QUESTS (30 XP each) - Expanded library
  {
    ...
    description:
      "Complete a major endurance challenge: run 10K, hike for 3+ hours, bike 25+ miles, or swim 2+ miles",
    category: "fitness",
  ...
  },
  {
    ...
    description:
      "Deeply study a complex topic for 3+ hours: research thoroughly, take detailed notes, and create a summary or teach it to someone",
    category: "learning",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🧠",
  ...
  },
  {
    ...
    title: "Project Hero",
    description:
      "Complete a major project deliverable: finish a presentation, submit a proposal, deploy code, or complete a significant work milestone",
    category: "career",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🚀",
  ...
  },
  {
    ...
    title: "Digital Monk",
    description:
      "Stay completely offline for an entire day: no social media, news websites, entertainment apps, or non-essential digital devices",
    category: "recovery",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🚫",
  ...
  },
  {
    ...
    description:
      "Completely reorganize a major life area: create a budget and financial plan, deep clean and organize your home, or overhaul your productivity system",
    category: "productivity",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🏗️",
  ...
  },
  {
    ...
    description:
      "Complete a 24-hour mindful fast with only water, using the time for reflection, meditation, and mental clarity (consult doctor if needed)",
    category: "mindfulness",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🌙",
  ...
  },
  {
    ...
    description:
      "Create and publicly share significant creative work: publish a blog post/story, post artwork online, perform music, or showcase your creation to others",
    category: "creativity",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "⭐",
  ...
  },
  {
    ...
    description:
      "Organize or participate in a community event: volunteer for 4+ hours, organize a charity drive, mentor someone, or lead a community initiative",
    category: "social",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🌟",
  ...
  },
  {
    ...
    description:
      "Implement a complete healthy day: meal prep all meals, exercise twice, drink only water, get 8+ hours sleep, and avoid all processed foods",
    category: "health",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "🔄",
  ...
  },
  {
    ...
    description:
      "Face a significant personal fear: give a public speech, ask for a raise, have a difficult conversation, or take action on something you've been avoiding",
    category: "personal",
    difficulty: "very_hard",
    xpReward: QUEST_XP_VALUES.very_hard,
    icon: "⚔️",
...
export function getQuestsByDifficulty(
...
export function getRandomQuest(
  ...
  let availableQuests = getQuestsByDifficulty(difficulty).filter(
    (quest) => !excludeIds.includes(quest.id),
  );
